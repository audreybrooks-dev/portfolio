...
let edu_maxIndex = edu_cards.length - 1;    // Number of cards we have
...
function updateEduCarousel() {
    ...
    const edu_gap = 44; 
    const edu_movement = edu_currentIndex * (cardHeight + edu_gap);

    // Conduct movement
    edu_track.style.transform = `translateY(-${edu_movement}px)`;
